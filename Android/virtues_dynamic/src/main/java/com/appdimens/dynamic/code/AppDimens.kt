 ...
 * acting as a gateway to the `VirtuesFixed` and `VirtuesDynamic` constructors.
 *
 * [PT] Objeto singleton que fornece funções para gerenciamento de dimensões responsivas,
 * agindo como um gateway para os construtores `VirtuesFixed` e `VirtuesDynamic`.
 */
object Virtues {

    /**
     * [EN] Gateway for `VirtuesFixed`.
     *
     * [PT] Gateway para `VirtuesFixed`.
     */
     ...
     *
     * [PT] Inicia o construtor `VirtuesFixed` a partir de um valor Float em Dp.
     ...
     */
    fun fixed(initialValueDp: Float, ignoreMultiViewAdjustment: Boolean = false): VirtuesFixed =
        VirtuesFixed(initialValueDp, ignoreMultiViewAdjustment)
     ...
     * @param ignoreMultiViewAdjustment If true, ignores multi-view adjustments.
     *
     * [PT] Inicia o construtor `VirtuesFixed` a partir de um valor Int em Dp.
     * @param initialValueInt O valor inicial em Dp (Int).
     * @param ignoreMultiViewAdjustment Se verdadeiro, ignora os ajustes de multi-view.
     */
    fun fixed(initialValueInt: Int, ignoreMultiViewAdjustment: Boolean = false): VirtuesFixed =
        VirtuesFixed(initialValueInt.toFloat(), ignoreMultiViewAdjustment)


    /**
     * [EN] Gateway for `VirtuesDynamic`.
     *
     * [PT] Gateway para `VirtuesDynamic`.
     */
     ...
     * @param ignoreMultiViewAdjustment If true, ignores multi-view adjustments.
     *
     * [PT] Inicia o construtor `VirtuesDynamic` a partir de um valor Float em Dp.
     * @param initialValueDp O valor inicial em Dp (Float).
     * @param ignoreMultiViewAdjustment Se verdadeiro, ignora os ajustes de multi-view.
     */
    fun dynamic(initialValueDp: Float, ignoreMultiViewAdjustment: Boolean = false): VirtuesDynamic =
        VirtuesDynamic(initialValueDp, ignoreMultiViewAdjustment)
     ...
     * @param ignoreMultiViewAdjustment If true, ignores multi-view adjustments.
     *
     * [PT] Inicia o construtor `VirtuesDynamic` a partir de um valor Int em Dp.
     * @param initialValueInt O valor inicial em Dp (Int).
     * @param ignoreMultiViewAdjustment Se verdadeiro, ignora os ajustes de multi-view.
     */
    fun dynamic(initialValueInt: Int, ignoreMultiViewAdjustment: Boolean = false): VirtuesDynamic =
        VirtuesDynamic(initialValueInt.toFloat(), ignoreMultiViewAdjustment)
