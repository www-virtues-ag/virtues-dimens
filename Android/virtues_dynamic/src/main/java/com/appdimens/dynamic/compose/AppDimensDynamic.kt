...
class VirtuesDynamic(
     ...
     */
    fun screen(type: UiModeType, customValue: Dp): VirtuesDynamic {
     ...
     */
    fun screen(type: UiModeType, customValue: TextUnit): VirtuesDynamic {
     ...
     */
    fun screen(uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Int, customValue: TextUnit): VirtuesDynamic {
     ...
     */
    fun screen(uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Int, customValue: Float): VirtuesDynamic {
        val key = UiModeQualifierEntry(uiModeType = uiModeType, dpQualifierEntry = DpQualifierEntry(qualifierType, qualifierValue))
     ...
     */
    fun screen(uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Int, customValue: Int): VirtuesDynamic {
        val key = UiModeQualifierEntry(uiModeType = uiModeType, dpQualifierEntry = DpQualifierEntry(qualifierType, qualifierValue))
        customIntersectionMap[key] = customValue.dp
        return this
    }
     ...
     */
    fun screen(type: DpQualifier, value: Int, customValue: TextUnit): VirtuesDynamic {
