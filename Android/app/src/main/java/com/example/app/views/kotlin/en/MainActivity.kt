...
import ag.virtues.dimens.example.databinding.ActivityDynamicDataBindingBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("VirtuesExample", "1. Dynamic (DB) - Initial Value: ${dimenValue}dp")
    ...
    private fun demonstrateFixedUsage(view: View) {
        ...
        val fixedPx = VirtuesDimensFixed(dpValue).toPx(resources)

        Log.d("VirtuesExample", "2. Fixed: ${dpValue}dp -> ${fixedPx}px")
    ...
    private fun demonstratePercentageUsage(view: View) {
        ...
        val percentagePx = VirtuesDimens.dynamicPercentagePx(
            percentage = percentage,
            type = ScreenType.LOWEST,
            resources = resources
        )

        Log.d("VirtuesExample", "3. Percentage: ${percentage * 100}% of ${ScreenType.LOWEST} -> ${percentagePx}px")
    ...
    private fun demonstratePhysicalUnitUsage(view: View) {
        ...
        val mmInPx = VirtuesDimensPhysicalUnits.toMm(mmValue, resources)

        Log.d("VirtuesExample", "4. Physical: ${mmValue}mm -> ${mmInPx}px")
