...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("VirtuesDimensExample", "1. Dynamic (DB) - Initial value: " + dimenValue + "dp");
     ...
     *
     * [PT] 2. Demonstra o uso do VirtuesDimensFixed (DP Fixo) para manter a dimensão
    ...
    private void demonstrateFixedUsage(View view) {
        ...
        Log.d("VirtuesDimensExample", "2. Fixed: " + dpValue + "dp -> " + fixedPx + "px");
    ...
    private void demonstratePercentageUsage(View view) {
        ...
        Log.d("VirtuesDimensExample", "3. Percentage: " + (percentage * 100) + "% of "
    ...
    private void demonstratePhysicalUnitUsage(View view) {
        ...
        Log.d("VirtuesDimensExample", "4. Physical: " + mmValue + "mm -> " + mmInPx + "px");
